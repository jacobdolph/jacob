...
function Navmobile(props) {
    return (
        ...
        <ul className="sidenav" id="mobile-demo" style={{ backgroundColor: 'white' }}>
            <li><Link onClick={props.home} style={{ color: "#37474f", fontSize: '2rem' }} className='sidenav-close' to='/'>Home</Link></li>
            <li><Link onClick={props.portfolio} style={{ color: "#37474f", fontSize: '2rem' }} className='sidenav-close' to='/portfolio'>Portfolio</Link></li>
            <li><Link onClick={props.tech} style={{ color: "#37474f", fontSize: '2rem' }} className='sidenav-close' to='/Connect'>Tech</Link></li>
            <br />
            <br />
